# Contributing to Synapse & Developer Guide

Thank you for your interest in contributing to **Synapse**! This document provides comprehensive guidelines and technical documentation for developers, including architecture overviews, local environment setup, service endpoints, database schemas, testing procedures, and our contribution workflow.
...
- [Contribution Workflow](#contribution-workflow)
  - [1. Fork & Branch Workflow](#1-fork--branch-workflow)
  - [2. Conventional Commit Standards](#2-conventional-commit-standards)
  - [3. Contribution Checklist](#3-contribution-checklist)
...
- [Complete REST API Reference](#complete-rest-api-reference)
  - [1. Authentication & Session](#1-authentication--session-apiv1login)
  - [2. User & Profile Management](#2-user--profile-management-apiv1users)
  - [3. Developer Workspace](#3-developer-workspace-apiv1developer)
  - [4. Model Owner Workspace](#4-model-owner-workspace-apiv1owner)
...
- [Linting, Formatting & Code Quality](#linting--formatting)
...
We welcome contributions from the open-source community! Whether fixing bugs, adding new model evaluation metrics, improving documentation, or creating new integrations, please follow these guidelines:
...
The following diagram outlines the high-level architecture of Synapse, illustrating the interaction between the React frontend, Traefik reverse proxy, FastAPI backend, MongoDB Beanie ODM layer, and external AI services.
...
├── CONTRIBUTING.md             # Developer setup, architecture & contribution guide
